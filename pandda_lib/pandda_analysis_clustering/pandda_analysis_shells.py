...
def get_shells_pandda_analysis_clustering(
    ...
    for res in reses:
        resolution_shell_dtags = {_dtag: _resolution for _dtag, _resolution in resolutions.items() if
                                  _resolution > res}
