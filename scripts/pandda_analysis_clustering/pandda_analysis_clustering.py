...
# from pandda_lib.pandda_analysis_clustering.pandda_analysis_shells import get_shells_pandda_analysis
from pandda_lib.pandda_analysis.pandda_analysis_model import analyse_model_pandda_analysis
# from pandda_lib.pandda_analysis_clustering.pandda_analysis_process import process_shell_multiple_models_pandda_analysis
...
from pandda_lib.pandda_analysis_clustering.pandda_analysis_shells import get_shells_pandda_analysis_clustering
# from pandda_lib.pandda_analysis_clustering.pandda_analysis_model import analyse_model_pandda_analysis
from pandda_lib.pandda_analysis_clustering.pandda_analysis_process import \
    process_shell_multiple_models_pandda_analysis_clustering
# from pandda_lib.pandda_analysis_clustering.pandda_analysis_args import PanDDAArgsPanDDAAnalysis
# from pandda_lib.pandda_analysis_clustering.test_point_to_reference_frame import get_test_pos_in_reference_frame
...
def process_pandda(pandda_args: PanDDAArgsPanDDAAnalysis, ):
    ...
    try:
        ...
        with STDOUTManager('Deciding on how to partition the datasets into resolution shells for processing...',
                           f'\tDone!'):
            # if pandda_args.comparison_strategy == "cluster" or pandda_args.comparison_strategy == "hybrid":
            shells: ShellsInterface = get_shells_pandda_analysis_clustering(
                datasets,
                comparators,
            ...
            shell_results: ShellResultsInterface = {
                ...
                in zip(
                    ...
                    process_global(
                        [
                            Partial(
                                process_shell_multiple_models_pandda_analysis_clustering).paramaterise(
                                shell,
                                datasets,
                                alignments,
                                grid,
