...
PANDDA_JOB_TEMPLATE = (
    ...
    "python -u "
    "/dls/science/groups/i04-1/conor_dev/pandda_lib/scripts/pandda_analysis/pandda_analyis.py "
    "--data_dirs={data_dirs} "
    "--out_dir={out_dir} "
    "--pdb_regex=\"{pdb_regex}\" "
    "--mtz_regex=\"{mtz_regex}\" "
...
def run_pandda_analyses(targets_json_path: str):
